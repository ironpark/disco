...
class FinalEnricher:
    ...
    def __init__(
        ...
        *,
        ...
        self._pending: EnrichedFinal | None = None
    ...
    def _enrich(self, event: Final) -> EnrichedFinal:
    ...
    def _handle_enriched(self, event: EnrichedFinal) -> None:
        if self._pending is None:
            self._pending = event
            debug_log(
                "enrich",
